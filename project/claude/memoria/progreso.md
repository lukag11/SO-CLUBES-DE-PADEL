...
**Última actualización:** 2026-07-06 — **ASCENSO/DESCENSO DE CATEGORÍAS: cierre** (jugador VE la felicitación · indicador enriquecido en la tabla · historial/auditoría `CambioCategoria` + descenso manual · notif pareja para todo cambio). Antes (mismo día): Bloques 1 (motor) + 2 (el "cut") + 4 (WIarky). Ver abajo.
