    ...
    <div className="flex flex-col gap-6">
          ...
          <div className="relative">
            ...
            {settingsOpen && (
              <>
                ...
                <div className="absolute left-0 sm:left-auto sm:right-0 mt-2 w-56 max-w-[calc(100vw-2rem)] bg-white border border-slate-200 rounded-xl shadow-lg z-20 overflow-hidden py-1">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        {loading ? (
          ...
          <div>
            {visibles.map((c, idx) => (
              <div key={c.id} className={`flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 px-4 sm:px-5 py-4 border-b border-slate-100 transition-colors ${idx % 2 === 1 ? 'bg-slate-100' : 'bg-white'} hover:bg-brand-50/60`}>
                <div className="flex-1 min-w-0">
                ...
                <p className="text-slate-800 font-bold text-sm shrink-0 text-right sm:w-20">{money(c.monto)}</p>
