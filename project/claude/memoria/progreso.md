...
**Última actualización:** 2026-07-06 — **ASCENSO DE CATEGORÍAS: Bloque 1 (motor) + Bloque 2 (el "cut") + Bloque 4 (WIarky lo detecta, lo cuenta y lo ejecuta)**. Modelo asistido + reglas de títulos (no ELO). Antes (2026-07-05): UI torneos; módulo financiero. Ver abajo.
