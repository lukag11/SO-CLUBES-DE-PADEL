...
**Última actualización:** 2026-07-11 (tarde) — **CORRECCIONES UI + venta rápida** — botón "Por cobrar" del dashboard ahora abre la tab correcta (Cobranzas, no Ventas); "Venta rápida" desde el Resumen (atajo al modal de venta que ya existe); fix: en una venta, "Anotar a cuenta" cierra la operación; fade suave al volver al Resumen; y fix del badge de notificaciones (el stock ya no infla el contador de Reservas del sidebar). Ver bloque abajo. **Próximo: RESPONSIVE (WIarky no se ve bien en mobile).**
