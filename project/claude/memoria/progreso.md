...
**Última actualización:** 2026-07-11 (tarde 3) — **UBICACIÓN EN MAPA (Leaflet gratis) + sección Contacto en la landing** — el admin marca la ubicación exacta del club en un mapa (modal) y se muestra en la landing pública en una sección Contacto rediseñada (WhatsApp protagonista, redes, mapa + Cómo llegar), en los 5 templates. Ver bloque abajo. **Próximo: RESPONSIVE (WIarky no se ve bien en mobile).**
