...
**Última actualización:** 2026-07-12 — **TORNEOS (cards) + FINANZAS mobile + WIarky PROACTIVO (motor de nudges)** — rediseño de partidos de torneo a cards estilo dash jugador, fixes mobile de Finanzas, y WIarky pasó de pasivo a asistente proactivo que avisa/sugiere/opina solo (globito con el aviso del día + puntito + chat con botones). Ver bloque abajo. **Nota: el DEPLOY lo decide Luca, no empujarlo ([[feedback_deploy_luca_decide]]).**
