...
**Última actualización:** 2026-07-08 — **AI-OCR de gastos con WIarky**: el dueño sube foto de una factura y la IA (Claude visión) la lee y pre-llena el gasto para confirmar; el Gasto ahora guarda vencimiento y el sistema avisa (chip semáforo + WIarky proactivo). Ver abajo.
