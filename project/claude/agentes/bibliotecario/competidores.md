...
## Asistentes IA del vertical — mapa competitivo [ficha 2026-07-10]
> Clave para posicionar a WIarky. Cada competidor puso la IA en un cuadrante distinto; ninguno en el de WIarky.
- **Playtomic AI Assistant (WhatsApp) — IA para el JUGADOR.** Conversacional: reservar cancha, unirse/crear open matches, torneos, clases, pagos con Stripe, gestionar cuenta; aprende preferencias de juego. NO es owner-facing dentro del Manager. Internamente IA de soporte B2C (81 intents, 83% deflection). Fuente: playerhelp.playtomic.com (Meet Your Playtomic AI Assistant) [Verificado por snippet]. **Qué evitar:** competir del lado del jugador (su masa gana). **Qué tomar:** el patrón "hacé todo por conversación, sin navegar" — pero aplicado al DUEÑO.
- **Kananas — IA de REDACCIÓN + automatización.** "AI Writing Assistant" (emails/newsletters/resúmenes) + automatiza reservas/recordatorios/renovaciones/facturación. NO es un agente que ejecuta acciones sobre datos reales conversando. Copy: "¿Necesito conocimientos técnicos? No", trial 30 días, "ahorrá 2h/semana". Fuente: kananas.com [Verificado]. **Qué tomar:** el copy de venta ("ahorrá X horas", "sin conocimientos técnicos") y la generación de textos (WIarky ya la tiene en posteos/convocatorias).
- **Anolla — IA de SCHEDULING + dynamic pricing** (optimización, no conversación). Fuente: anolla.com [snippet].
- **SmashClub — CRM que "automatiza"** loyalty/torneos/ligas. Fuente: smashclub.cloud [snippet].
- **Clutch / Spash — IA de CÁMARA** (highlights + análisis de partido). Otro eje (visión), no gestión conversacional. Fuente: clutchapp.io, spash.com [snippet].
- **CONCLUSIÓN DE POSICIONAMIENTO:** ningún competidor tiene un asistente **conversacional OWNER-facing, grounded en los números reales del club, que EJECUTE tareas administrativas** (armar convocatoria, cargar gasto, registrar jugador, ascender, abrir caja) con confirmación humana. WIarky ocupa un cuadrante vacío = diferenciación real. El riesgo NO es que otro lo tenga: es que WIarky **no lo comunica en el onboarding** (el poder de acción es invisible al primer contacto). Ver oportunidades OP-WIARKY-1.
