...
- **Pendiente:** deploy + `MP_CLIENT_ID`/`MP_CLIENT_SECRET`/`MP_TOKEN_ENC_KEY` en Railway + probar conectando con vendedor de prueba. Luego S2 (resolveMpToken async+refresh), S3 (webhook /:clubId), S4 (UI), S5 (QA 2 clubes).
