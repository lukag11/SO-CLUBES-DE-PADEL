...
**Última actualización:** 2026-07-05 — **UI TORNEOS: retoque del template de fixture "Premier Padel" (nombres) + vista pública de grupos (acordeón/card compacta) + ajustes dash jugador**. Antes (mismo día): rediseño vista de zona; módulo financiero. Ver abajo.
