...
**Última actualización:** 2026-07-11 (tarde 4) — **REDISEÑO LANDING PÚBLICA — TEMPLATE 1** — overhaul visual completo del Template 1 (hero, reservas en grilla matriz, Americano "dos formatos enfrentados", galería mosaico con lightbox, servicios, historia, footer con firma PadelwIArk). Diseños nuevos hechos con `variant` para que NO se repliquen a los otros templates. Ver bloque abajo. **Próximo: rediseñar Templates 2-5 con identidad PROPIA (no copiar el 1) + RESPONSIVE.**
