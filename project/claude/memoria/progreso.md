...
**Última actualización:** 2026-07-11 (tarde 2) — **CARGO DE CANCELACIÓN configurable + más correcciones UI** — el cargo por cancelar fuera de plazo ahora es completo / mitad / % personalizado (antes hardcodeado al turno completo); panel "Avisos de jugadores" achicado a ~2 filas; perfil del mentor enriquecido con la forma de escribir/comunicarse de Luca. Ver bloque abajo. **Próximo: RESPONSIVE (WIarky no se ve bien en mobile).**
