...
**Última actualización:** 2026-07-09 — **GOLAZO: OCR de facturas que carga el stock (Etapa 1)** — la IA ahora lee también los ÍTEMS de la factura (renglones de producto) y el dueño los confirma para cargarlos al STOCK con su costo → alimenta el COGS/margen que ya existe. Cierra el círculo OCR → Stock → Margen. Ver abajo. RN-68.
