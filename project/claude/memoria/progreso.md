...
**Última actualización:** 2026-07-05 — **UI TORNEOS: vista pública de grupos (card compacta + acordeón "Ver partidos") + cuadro del dash jugador en formato "stat" + "Eliminado" oculto al finalizar**. Antes (mismo día): rediseño UI vista de zona del dash jugador; módulo financiero. Ver abajo.
