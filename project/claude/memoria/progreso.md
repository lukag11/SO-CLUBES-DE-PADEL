...
**Última actualización:** 2026-07-06 — **MI CONSUMO: sección de pagos del jugador rediseñada + flag del club (`mostrarConsumoJugador`).** Antes (mismo día): RETOQUES UI JUGADOR (mobile) · CORTE MANUAL DE CATEGORÍA EN TORNEOS · ASCENSO/DESCENSO cierre. Ver abajo.
