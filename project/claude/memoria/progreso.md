...
**Última actualización:** 2026-07-11 — **WIarky: se cerró TODO el roadmap de la auditoría (menos voz iPhone)** — push de los 4 commits pendientes + 3 cerebros financieros enchufados (turnos fijos en riesgo, heatmap, flujo de caja) + 2 fixes (categoría canónica en crear_jugador, cargar_gasto ya no marca todo pagado) + prompt caching. Ver bloque abajo. **Próximo: unas correcciones más y después RESPONSIVE (WIarky no se ve bien en mobile).**
