...
**Última actualización:** 2026-07-09 — **Refinamiento del AI-OCR de gastos** (afinado con facturas reales de un club): categorías por rubro de club, fix CONTADO/Vto CAE, CUIT+tipo de comprobante (opcionales), el OCR ya NO guarda la foto (lee como scanner), filtro por proveedor + total y detector de facturas duplicadas (aviso). Ver abajo. RN-67.
