...
- **Pendiente (Bloque 4-B, refactor aparte con QA):** theming (color `#afca0b` hardcodeado ~422 usos → token) para white-label real. NO arrancado (riesgo alto, pantalla por pantalla).
