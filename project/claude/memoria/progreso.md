...
**Última actualización:** 2026-07-05 — **REDISEÑO UI DE LA VISTA DE ZONA/GRUPOS (dash jugador) + varias correcciones puntuales** (marca de agua del bracket, badge FINALIZADO en agenda, sets verticales). Antes: módulo financiero (pulido + auditoría + LTV/churn). Ver abajo.
